...
namespace Knedlex.Roblox.Avatar.ApiV1.Api
{
    ...
    public partial class BatchApi : IBatchApi
    {
        ...
        /// <returns></returns>
        public BatchApi(Knedlex.Roblox.Avatar.ApiV1.Client.Configuration configuration)
        {
        ...
        public BatchApi(Knedlex.Roblox.Avatar.ApiV1.Client.ISynchronousClient client, Knedlex.Roblox.Avatar.ApiV1.Client.IAsynchronousClient asyncClient, Knedlex.Roblox.Avatar.ApiV1.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Knedlex.Roblox.Avatar.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailBatchResponse> localVarResponse = V1BatchPostWithHttpInfo(requests, robloxPlaceId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailBatchResponse</returns>
        public Knedlex.Roblox.Avatar.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailBatchResponse> V1BatchPostWithHttpInfo(List<RobloxThumbnailsApisModelsThumbnailBatchRequest> requests, long? robloxPlaceId = default(long?), int operationIndex = 0)
        {
            // verify the required parameter 'requests' is set
            if (requests == null)
            {
                throw new Knedlex.Roblox.Avatar.ApiV1.Client.ApiException(400, "Missing required parameter 'requests' when calling BatchApi->V1BatchPost");
            }
        ...
        {
            Knedlex.Roblox.Avatar.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailBatchResponse> localVarResponse = await V1BatchPostWithHttpInfoAsync(requests, robloxPlaceId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailBatchResponse)</returns>
        public async System.Threading.Tasks.Task<Knedlex.Roblox.Avatar.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailBatchResponse>> V1BatchPostWithHttpInfoAsync(List<RobloxThumbnailsApisModelsThumbnailBatchRequest> requests, long? robloxPlaceId = default(long?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'requests' is set
            if (requests == null)
            {
