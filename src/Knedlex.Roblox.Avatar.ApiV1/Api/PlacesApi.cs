...
namespace Knedlex.Roblox.Avatar.ApiV1.Api
{
    ...
    public partial class PlacesApi : IPlacesApi
    {
        ...
        /// <returns></returns>
        public PlacesApi(Knedlex.Roblox.Avatar.ApiV1.Client.Configuration configuration)
        {
        ...
        public PlacesApi(Knedlex.Roblox.Avatar.ApiV1.Client.ISynchronousClient client, Knedlex.Roblox.Avatar.ApiV1.Client.IAsynchronousClient asyncClient, Knedlex.Roblox.Avatar.ApiV1.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Knedlex.Roblox.Avatar.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = V1PlacesGameiconsGetWithHttpInfo(placeIds, returnPolicy, size, format, isCircular);
        ...
        public Knedlex.Roblox.Avatar.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> V1PlacesGameiconsGetWithHttpInfo(List<long> placeIds, string returnPolicy = default(string), string size = default(string), string format = default(string), bool? isCircular = default(bool?), int operationIndex = 0)
        {
            ...
            if (placeIds == null)
            {
                throw new Knedlex.Roblox.Avatar.ApiV1.Client.ApiException(400, "Missing required parameter 'placeIds' when calling PlacesApi->V1PlacesGameiconsGet");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(Knedlex.Roblox.Avatar.ApiV1.Client.ClientUtils.ParameterToMultiMap("csv", "placeIds", placeIds));
        ...
        {
            Knedlex.Roblox.Avatar.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = await V1PlacesGameiconsGetWithHttpInfoAsync(placeIds, returnPolicy, size, format, isCircular, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
