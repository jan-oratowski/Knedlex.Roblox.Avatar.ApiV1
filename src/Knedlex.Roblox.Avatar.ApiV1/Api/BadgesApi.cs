...
namespace Knedlex.Roblox.Avatar.ApiV1.Api
{
    ...
    public partial class BadgesApi : IBadgesApi
    {
        ...
        /// <returns></returns>
        public BadgesApi(Knedlex.Roblox.Avatar.ApiV1.Client.Configuration configuration)
        {
        ...
        public BadgesApi(Knedlex.Roblox.Avatar.ApiV1.Client.ISynchronousClient client, Knedlex.Roblox.Avatar.ApiV1.Client.IAsynchronousClient asyncClient, Knedlex.Roblox.Avatar.ApiV1.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Knedlex.Roblox.Avatar.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = V1BadgesIconsGetWithHttpInfo(badgeIds, size, format, isCircular);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse</returns>
        public Knedlex.Roblox.Avatar.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> V1BadgesIconsGetWithHttpInfo(List<long> badgeIds, string size = default(string), string format = default(string), bool? isCircular = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'badgeIds' is set
            if (badgeIds == null)
            {
                throw new Knedlex.Roblox.Avatar.ApiV1.Client.ApiException(400, "Missing required parameter 'badgeIds' when calling BadgesApi->V1BadgesIconsGet");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(Knedlex.Roblox.Avatar.ApiV1.Client.ClientUtils.ParameterToMultiMap("csv", "badgeIds", badgeIds));
            if (size != null)
            {
        ...
        {
            Knedlex.Roblox.Avatar.ApiV1.Client.ApiResponse<RobloxWebWebAPIModelsApiArrayResponseRobloxWebResponsesThumbnailsThumbnailResponse> localVarResponse = await V1BadgesIconsGetWithHttpInfoAsync(badgeIds, size, format, isCircular, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
