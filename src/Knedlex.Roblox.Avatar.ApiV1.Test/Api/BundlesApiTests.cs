...
namespace Knedlex.Roblox.Avatar.ApiV1.Test.Api
{
    ...
    public class BundlesApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test V1BundlesThumbnailsGet
        /// </summary>
        [Fact]
        public void V1BundlesThumbnailsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //List<long> bundleIds = null;
            //string size = null;
            //string format = null;
            //bool? isCircular = null;
            //var response = instance.V1BundlesThumbnailsGet(bundleIds, size, format, isCircular);
